...
```bash
git clone [https://github.com/YOUR-USERNAME/I-AM-CONTRIBUTOR.git](https://github.com/YOUR-USERNAME/I-AM-CONTRIBUTOR.git)
cd I-AM-CONTRIBUTOR
```
...
```bash
git checkout -b feat/add-contributor-[your-name]
```
...
git commit -m "feat: add [Your Name] to the wall of fame"
```

### 6. Push and Create Pull Request
```bash
git push origin feat/add-contributor-[your-name]
```
